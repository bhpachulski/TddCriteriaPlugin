...
public class TDDLaunchShortcut implements ILaunchShortcut, IExecutableExtension {
...
//			delegate.launch(selection, CoverageTools.LAUNCH_MODE);
		...
		System.out.println("AQUI 1 " + mode);
	}
...
//			delegate.launch(editor, CoverageTools.LAUNCH_MODE);
		...
		System.out.println("AQUI 2 " + mode);
	}
	...
	public void setInitializationData(IConfigurationElement config,
		...
		System.out.println("AQUI 3 " + propertyName);
	}
